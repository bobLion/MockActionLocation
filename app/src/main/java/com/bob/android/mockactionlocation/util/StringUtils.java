...
/**
 * Created by eagle on 2017-9-18 18:53
 */
...
public class StringUtils {
     ...
     */
    public static String getIDCaardSex(String certificateNo) {
        String sexCode = "";
    ...
    public static long getLongTime(String stringTime){
        ...
        Date dt2 = null;
        try {
            dt2 = sdf.parse(stringTime);
        } catch (ParseException e) {
            e.printStackTrace();
        }
//继续转换得到秒数的long型
        long longTime = dt2.getTime() / 1000;
        return longTime;
    }
}
